...
docker exec -i gccalpine$1 sh -c "echo """" > /home/compiler/output/retorno.txt && echo """" > /home/compiler/output/validacao.txt && echo ""nao"" > /home/compiler/output/timeout.txt" 
...
docker exec -i gccalpine$1 sh -c "if gcc -Wall -Wextra  -std=c99 -D_GNU_SOURCE /home/compiler/input/input.c -o /home/compiler/input/input_compiled$1 2> /home/compiler/output/retorno.txt; then printf ""sim"" >> /home/compiler/output/stdout_temp.txt && ./home/compiler/input/timeout_script.sh $1; else printf ""nao"" >> /home/compiler/output/stdout_temp.txt; fi"
...
docker cp gccalpine$1:/home/compiler/output/stdout.txt /tmp/stdout$1.json && docker rm gccalpine$1
